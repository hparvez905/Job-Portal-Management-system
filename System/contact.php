...
<head>
	...
	<title>Chakri.com - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Jagannath University, <br/> Cse Department, <br/>Core71</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:hparvez905@gmail.com">hparvez905@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+8801521431055">+8801521431055</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Chakri.com</h5>
											<p>Chakri.com is a job portal, online job management system developed by Core71 for their University project in November 2022.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Chakri.com Contact</h5>
								
								<p>Address : Jagannath University</p>
								<p>Email : <a href="mailto:hparvez905@gmail.com">hparvez905@gmail.com</a></p>
								<p>Phone : <a href="tel:+8801521431055">+8801521431055</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Core71 Software Team</p>
